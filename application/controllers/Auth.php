...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->form_validation->set_rules('email', 'Email', 'required|trim|valid_email|is_unique[user.email]', [
                'is_unique' => 'This email has alredy registed!'
            ]);
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'haikaljavierrachman@gmail.com',
            'smtp_pass' => 'haikaljavier140902',
            'smtp_port' => 465,
            'mailtype' => 'html',
            'charser' => 'utf-8',
            'newline' => "\r\n"
        ...
        $this->email->from('belajarprogphp@gmail.com', 'Belajar Pemrograman PHP');
    ...
    public function changePassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-succcess" role="alert">
